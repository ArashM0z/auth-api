...
<!-- The card grid lives in an include: Material grid cards need 4-space
     continuation indents (python-markdown), which formatters would collapse.
     The _includes/ directory is prettier-ignored and excluded from the nav. -->

--8<-- "docs/_includes/home-cards.md"
...
| **Tests**            | 86 tests, ~97% coverage, 5 layers + Stryker mutation testing (87%, gate 80%)                                   |
